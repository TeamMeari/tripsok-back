...
WHEN MATCHED THEN UPDATE SET
                      t.PLACE_NAME  = NVL(s.PLACE_NAME,  t.PLACE_NAME),
                      ...
                      WHEN NOT MATCHED THEN INSERT
                                                ...
                                                VALUES
(s.PLACE_ID, s.LOCALE, s.PLACE_NAME, s.ADDRESS, s.INFORMATION, s.SUMMARY);


ALTER TABLE PLACE_LCLS_CATEGORY ADD LOCALE VARCHAR2(20 CHAR);

UPDATE PLACE_LCLS_CATEGORY SET LOCALE = 'ko' WHERE LOCALE IS NULL;

ALTER TABLE PLACE_LCLS_CATEGORY MODIFY LOCALE CONSTRAINT NN_PLLC_LOCALE NOT NULL;
ALTER TABLE PLACE_LCLS_CATEGORY ADD CONSTRAINT CK_PLLC_LOCALE_LOWER CHECK (LOCALE = LOWER(LOCALE));

ALTER TABLE PLACE_LCLS_CATEGORY DROP CONSTRAINT UQ_TOUR_LCLS_CATEGORY_CD;
ALTER TABLE PLACE_LCLS_CATEGORY ADD CONSTRAINT UQ_PLLC_LOCALE_L3CODE
    UNIQUE (LOCALE, LCLS_SYSTM3_CODE);

ALTER TABLE PLACE_LCLS_CATEGORY DROP CONSTRAINT PK_TOUR_LCLS_CATEGORY;
ALTER TABLE PLACE_LCLS_CATEGORY ADD CONSTRAINT PK_TOUR_LCLS_CATEGORY
